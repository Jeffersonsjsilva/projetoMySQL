...
insert into tbGenero(descGen) values('CONTO');
insert into tbGenero(descGen) values('POESIA');
insert into tbGenero(descGen) values('ROMANCE');
...
insert into tbAutor(nomeAut,emailAut) values('Machado de Assis','machado@gmail.com');
...
insert into tbLivro(idGenero,titLiv,precLiv,qtd_estq) values (1,'1984',70.00,300);
insert into tbLivro(idGenero,titLiv,precLiv,qtd_estq) values (6,'Critica da razão pura',45.00,200);
insert into tbLivro(idGenero,titLiv,precLiv,qtd_estq) values (10,'One piece',30.00,500);
insert into tbLivro(idGenero,titLiv,precLiv,qtd_estq) values (10,'Naruto',25.00,175);
insert into tbLivro(idGenero,titLiv,precLiv,qtd_estq) values (7,'Alice no país das maravilhas',20.00,150);
insert into tbLivro(idGenero,titLiv,precLiv,qtd_estq) values (5,'O poder do hábito',35.00,60);
insert into tbLivro(idGenero,titLiv,precLiv,qtd_estq) values (9,'A culpa é das estrelas',50.00,190);
select * from tbLivro;
...
insert into tbEscreve(idLivro,idAutor) values(10,10);
insert into tbEscreve(idLivro,idAutor) values(8,9);
insert into tbEscreve(idLivro,idAutor) values(6,7);
insert into tbEscreve(idLivro,idAutor) values(7,8);
...
insert into tbCliente(nomeCli,telCli) values('Guilherme Biro','41 92746-8346');
...
insert into tbItensDaVenda(idVenda,idLivro,qtdItens,valTotal) values(3,6,3,90.00);
insert into tbItensDaVenda(idVenda,idLivro,qtdItens,valTotal) values(4,7,2,50.00);
insert into tbItensDaVenda(idVenda,idLivro,qtdItens,valTotal) values(5,1,4,240.00);
insert into tbItensDaVenda(idVenda,idLivro,qtdItens,valTotal) values(6,10,3,150.00);
insert into tbItensDaVenda(idVenda,idLivro,qtdItens,valTotal) values(7,3,2,120.00);
insert into tbItensDaVenda(idVenda,idLivro,qtdItens,valTotal) values(8,4,2,90.00);
insert into tbItensDaVenda(idVenda,idLivro,qtdItens,valTotal) values(9,7,4,100.00);
insert into tbItensDaVenda(idVenda,idLivro,qtdItens,valTotal) values(10,8,5,100.00);
select * from tbItensDaVenda order by valTotal;
-- inserindo update na tabela tbGenero
update tbGenero set descGen = 'AUTO-BIOGRAFIA' where idGenero = 4;
update tbGenero set descGen = 'AVENTURA E JORNADA' where idGenero = 2;
update tbGenero set descGen = 'QUADRINHOS E MANGÁS' where idGenero = 10;
update tbGenero set descGen = 'FILOSOFIA E SOCIOLOGIA' where idGenero = 6;
update tbGenero set descGen = 'CONTO E FABULAS' where idGenero = 7;
select *from tbGenero;
...
update tbAutor set nomeAut = 'ALBERT CAMUS' where  idAutor = 3;
update tbAutor set nomeAut = 'N. GAIMAN' where  idAutor = 5;
update tbAutor set nomeAut = 'E. ODA' where  idAutor = 7;
select * from tbAutor;
-- inserindo update na tabela tbLivro
update tbLivro set qtd_estq = 125 where idLivro = 1;
update tbLivro set titLiv = 'O ESTRANGEIRO' where idLivro = 9;
update tbLivro set qtd_estq = 180 where idLivro = 7;
update tbLivro set qtd_estq = 70 where idLivro = 9;
update tbLivro set qtd_estq = 90 where idLivro = 4;
select * from tbLivro order by qtd_estq;

-- inserindo update na tabela tbEscreve
update tbEscreve set idLivro = 9 where idAutor = 3;
update tbEscreve set idLivro = 10 where idAutor = 2;
update tbEscreve set idLivro = 4 where idAutor = 3;
update tbEscreve set idLivro = 6 where idAutor = 4;
update tbEscreve set idLivro = 7 where idAutor = 6;
select * from tbEscreve;
...
update tbCliente set nomeCli = 'Matias Rojas' where idCliente = 5;
update tbCliente set TelCli = '11 98742-7358' where idCliente = 5;
update tbCliente set nomeCli = 'Dimitri Payet' where idCliente = 4;
select * from tbCliente;
...
update tbItensDaVenda set valTotal = 210.00 where idVenda = 2;
update tbItensDaVenda set qtdItens = 4 where idVenda = 8;
update tbItensDaVenda set valTotal = 180.00 where idVenda = 8;
update tbItensDaVenda set valTotal = 90.00 where idVenda = 10;
select * from tbItensDaVenda order by valTotal;

delete from tbGenero where idGenero = 9 and descGen = 'ROMANCE';